...
## same files, different executable name
40image-6: 40image.o COMP40compressor.o bitpack.o pixelConverter.o pixelBitpacker.o wordIO.o a2plain.o a2blocked.o uarray2.o uarray2b.o 
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

40image: 40image.o COMP40compressor.o bitpack.o pixelConverter.o pixelBitpacker.o wordIO.o a2plain.o a2blocked.o uarray2.o uarray2b.o 
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

compTester: compTester.o bitpack.o pixelConverter.o pixelBitpacker.o wordIO.o a2plain.o a2blocked.o uarray2.o uarray2b.o 
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
